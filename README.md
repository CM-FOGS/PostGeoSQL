An international research project that provides an extensible library of geospatial functions that run on the PostgreSQL relational database management system with the PostGIS spatial extension.
...
A brief description of how geo-functions work is generally published on the Q&A website at the following link - https://gis.stackexchange.com, https://stackoverflow.com. 
